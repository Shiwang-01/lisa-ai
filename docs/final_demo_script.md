...
- **Primary Interface:** FastAPI Nurse Workstation
...
**TIME:** 0:25–0:50 (25s)  
**SCREEN / ACTION:** Show LISA.ai Nurse Command Center in Normal Mode.  
...
**WHAT THE JUDGE SHOULD NOTICE:** Clean, professional workstation. The disclaimer: "Prototype simulation only — not for clinical use."  
...
**TIME:** 0:50–1:50 (60s)  
**SCREEN / ACTION:** Select Patient A125 in the live queue. View Patient vitals and Risk-of-Wait trajectory chart in the center panel.  
...
**TIME:** 1:50–2:25 (35s)  
**SCREEN / ACTION:** Select Patient A135 in the live queue. View Safety Floor banner in center panel.  
...
**TIME:** 2:25–3:05 (40s)  
**SCREEN / ACTION:** Toggle Operational Mode to "Surge 3×". Observe queue and metric updates.  
...
## 3:05–3:35 — SECTION 6: CAPACITY WORKSPACE

**TIME:** 3:05–3:35 (30s)  
**SCREEN / ACTION:** Navigate to the Capacity Workspace. Highlight allocated spaces and awaiting-suitable list.  
**EXACT SPEAKER SCRIPT:** "LISA does not simply give beds to ranks one through eight. It considers resource compatibility across our 8 simulated ED spaces. A stable low-acuity injury can use fast-track, preserving monitored or higher-capability resources for patients who need them. Urgency and resource compatibility are different operational problems."  
**WHAT THE JUDGE SHOULD NOTICE:** Clean compatibility matching. No raw procedural strings presented as allocation recommendations.  
**DO NOT SAY:** LISA assigns treatments, LISA orders CT scans.  

---

## 3:35–4:00 — SECTION 7: CLINICIAN CONTROL & AUDIT

**TIME:** 3:35–4:00 (25s)  
**SCREEN / ACTION:** Return to Patient A125 in Command. Open Clinician Override modal. Override to Tier B, select reason 'Clinical Appearance', add note, submit, then switch to Audit workspace.  
...
## 4:00–4:20 — SECTION 8: EVIDENCE WORKSPACE

**TIME:** 4:00–4:20 (20s)  
**SCREEN / ACTION:** Switch to the Evidence Workspace. Highlight the 0 dynamic-priority inversions metric.  
...
## 4:20–4:35 — SECTION 9: GOVERNANCE WORKSPACE

**TIME:** 4:20–4:35 (15s)  
**SCREEN / ACTION:** Click the Governance workspace. Show Implemented vs. Production requirements panels.  
...
**TIME:** 4:35–4:45 (10s)  
**SCREEN / ACTION:** Switch back to the Command workspace.  
...
**WHAT THE JUDGE SHOULD NOTICE:** Final professional view of the operational workstation.  
